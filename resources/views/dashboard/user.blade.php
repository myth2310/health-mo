                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge badge-sm border border-danger text-danger bg-danger border-radius-sm">
                                            <svg width="9" height="9" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><!--!Font Awesome Free 6.5.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                    ...
                                    <td class="text-sm font-weight-semibold text-dark">
                                        ...
                                        @endif
                                        <a href="/hapus/{{encrypt($data->user_id)}}" class="btn-sm btn-danger"><i class="fa-solid fa-trash" style="color: #ffffff;"></i></a>
                                    </td>
                                </tr>
                                @endforeach
                            </tbody>
